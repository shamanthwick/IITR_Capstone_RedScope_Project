...
def run_model(name: str, model: Pipeline, x_train, x_test, y_train, y_test, samples) -> None:
...
def main() -> None:
    ...
    run_model("Word-token baseline", build_word_model(), x_train, x_test, y_train, y_test, evasion_samples)
    run_model("Char n-gram defender", build_char_model(), x_train, x_test, y_train, y_test, evasion_samples)
